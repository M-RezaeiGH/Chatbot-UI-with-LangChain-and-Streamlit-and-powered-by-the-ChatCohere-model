    ...
    def __init__(self, api_key):
        ...
        self.prompt_template = ChatPromptTemplate.from_messages(
            [
                ...
                ("placeholder", "{chat_history}"),#یک نگه‌دارنده برای نمایش تاریخچه‌ی گفت‌وگو
                ("human", "{input}"),
            ]
        )
        ...
        self.chain_with_message_history = RunnableWithMessageHistory(
            ...
            lambda session_id: self.chat_history,# بازگرداندن تاریخچه‌ی گفت‌وگو بر اساس شناسه‌ی جلسه
